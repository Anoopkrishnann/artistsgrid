...
export const mainCarouselData = [
  {
    ...
    category: "paintings",
    discount: 30,
    imgUrl: "/assets/images/banners/glittersliding.jpg",
  ...
  {
    id: 2,
    title: "Art in Every Dimension",
    category: "paintings",
    discount: 35,
    imgUrl: "/assets/images/banners/artistsgrid.jpg",
    description: "Get Free Shipping on orders over $99.00",
    buttonText: "Shop Now",
    buttonLink: "#",
  },
...
export const categories = [
  {
    ...
    name: "Paintings ",
    icon: null,
    image: "/assets/images/categories/yellow.jpg",
    slug: "Paintings",
    parent: [],
    description: null,
  ...
  },
  {
    ...
    name: "Sculptures",
    icon: null,
    image: "/assets/images/categories/Sculptures.jpg",
    slug: "Sculptures",
    parent: [],
    description: null,
    for: { demo: "market-2", type: "top-categories" },
  },
  {
    ...
    name: "Digital Art",
    icon: null,
    image: "/assets/images/categories/Digitallart.jpg",
    slug: "Digital Art",
    parent: [],
    description: null,
    for: { demo: "market-2", type: "top-categories" },
  ...
  },
  {
    ...
    name: "Ceramics",
    icon: null,
    image: "/assets/images/categories/Ceramicss.jpg",
    slug: "Ceramics",
    parent: [],
    description: null,
    for: { demo: "market-2", type: "top-categories" },
  },
  {
    ...
    name: "Photography",
    icon: null,
    image: "/assets/images/categories/Photographyy.jpg",
    slug: "Photography",
    parent: [],
    description: null,
    for: { demo: "market-2", type: "top-categories" },
...
export const products = [
  {
    ...
    title: "Silver High Neck Sweaterrrr",
    brand: null,
    price: 210,
    size: null,
    colors: [],
    discount: 0,
    thumbnail: "/assets/images/products/Fashion/Clothes/blue.jpeg",
    images: [
      "/assets/images/products/Fashion/Clothes/blue.jpeg",
      "/assets/images/products/Fashion/Clothes/blue.jpeg",
    ],
  ...
  },
  {
    ...
    colors: [],
    discount: 0,
    thumbnail: "/assets/images/products/Fashion/Clothes/1.jpeg",
    images: [
      "/assets/images/products/Fashion/Clothes/1.jpeg",
      "/assets/images/products/Fashion/Clothes/1.jpeg",
    ],
  ...
  },
  {
    ...
    colors: [],
    discount: 0,
    thumbnail: "/assets/images/products/Fashion/Clothes/elep.jpeg",
    images: [
      "/assets/images/products/Fashion/Clothes/elep.jpeg",
      "/assets/images/products/Fashion/Clothes/elep.jpeg",
    ],
    categories: ["Men's Fashion"],
    status: null,
  ...
  },
  {
    ...
    colors: [],
    discount: 0,
    thumbnail: "/assets/images/products/Fashion/Clothes/scene.jpeg",
    images: [
      "/assets/images/products/Fashion/Clothes/scene.jpeg",
      "/assets/images/products/Fashion/Clothes/scene.jpeg",
    ],
    categories: ["Men's Fashion"],
    status: null,
  ...
  },
  {
    ...
    colors: [],
    discount: 0,
    thumbnail: "/assets/images/products/Fashion/Clothes/green.jpeg",
    images: [
      "/assets/images/products/Fashion/Clothes/green.jpeg",
      "/assets/images/products/Fashion/Clothes/green.jpeg",
    ],
    categories: ["Women's Fashion"],
    status: null,
  ...
  },
  {
    ...
    colors: [],
    discount: 0,
    thumbnail: "/assets/images/products/Fashion/Clothes/duck.jpeg",
    images: [
      "/assets/images/products/Fashion/Clothes/duck.jpeg",
      "/assets/images/products/Fashion/Clothes/duck.jpeg",
    ],
    categories: ["Fashion"],
    status: null,
  ...
  },
  {
    ...
    colors: [],
    discount: 0,
    thumbnail: "/assets/images/products/Fashion/Shoes/buddh.jpeg",
    images: [
      "/assets/images/products/Fashion/Shoes/buddh.jpeg",
      "/assets/images/products/Fashion/Shoes/buddh.jpeg",
    ],
    categories: ["Men's Fashion"],
    status: null,
  ...
  },
  {
    ...
    colors: [],
    discount: 0,
    thumbnail: "/assets/images/products/Fashion/Shoes/bull.jpeg",
    images: [
      "/assets/images/products/Fashion/Shoes/bull.jpeg",
      "/assets/images/products/Fashion/Shoes/bull.jpeg",
    ],
    categories: ["Women's Fashion"],
    status: null,
