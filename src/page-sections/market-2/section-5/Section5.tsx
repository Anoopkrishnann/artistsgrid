    ...
    <Container pt="4rem">
      <Grid container spacing={5}>
        <Grid item md={4} xs={12}>
          <BannerCard3 img="/assets/images/banners/jewelery11.jpg">
            ...
            <H4 fontSize={20} lineHeight={1} my="1rem">
             Art Sale is Live 
              <br />
              <Span fontWeight={400} color="#ffffff">
                Up to 35% Off
              </Span>
            </H4>
        ...
        <Grid item md={4} xs={12}>
          <BannerCard3 img="/assets/images/banners/jewelery1.jpg">
        ...
        <Grid item md={4} xs={12}>
          <BannerCard3 img="/assets/images/banners/white.jpg">
            <Paragraph fontSize={13} letterSpacing={1.2}>
              NEW ARRIVALS
            </Paragraph>
