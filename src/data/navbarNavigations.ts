const navbarNavigations = [

  {
    title: "Home",
    child: [
     { title: "painting", url: "/market-1" },
      { title: "Print", url: "/market-2" },
      { title: "Photography", url: "/fashion-1" },
      { title: "Sculpture", url: "/fashion-2" },
      { title: "Drawing", url: "/fashion-3" },
      { title: "Artists", url: "/grocery-1" },
